...
function obtenerMayor(x, y) {
  ...
  // Tu código:
   if (x>y){return x;} else if (x<y) {return y;} else if (x === y) {return y||x;} 
}
...
function esEntero(numero) {
  ...
  if (numero % 1 === 0) {return true;}
    else if (numero > 0.9999999){return true;} else if  (numero < 0.999999) { return false;}
...
function fizzBuzz(numero) {
  ...
  if (numero % 3 === 0 && numero % 5 === 0){return "fizzbuzz";} else if (numero % 5 === 0){ return "buzz";}
  else if  (numero % 3 === 0 ){return "fizz";}return numero;
